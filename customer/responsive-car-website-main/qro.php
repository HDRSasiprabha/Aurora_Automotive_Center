...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $c_loc = mysqli_real_escape_string($con,$_POST['c_loc']);
    $description = mysqli_real_escape_string($con,$_POST['description']);
$sqlq = "INSERT INTO `appointment`( `type`, `c_loc`, `description`,`veh_id`, `cid`) 
VALUES ('qro',' $c_loc','$description',' $veh_id','$cid')";
if(mysqli_query($con, $sqlq)){
    echo "<script type='text/javascript'>alert('Your request placed successfully!');</script>";
} else{
            ...
            <div class="form-holder">
                <div class="form-content">
                    <div class="form-items">
                        <h3>Register Here for Requesting a Quick Recovering Service</h3>
                        <p>Fill in the data below.</p>
                        <!-- <form class="requires-validation" novalidate> -->
                        <form action="" method="POST" name="appointment" class="requires-validation" novalidate>
                           ...
                           <div class="col-md-12">
                           <input type="text" name="c_loc" placeholder="Current Location" required/>
...
<div id="us2" style="width: 500px; height: 400px;"></div> 
                            ...
                            <div class="col-md-12">
                              <input class="form-control" type="text" name="description" placeholder="Purpose" required>
                               
                           </div>
</br>
                            <div class="col-md-12 mt-3">
                                <button  type="submit" class="w3-button w3-round-large w3-hover-blue">Submit</button>
                                <a href="dashboard.php"><button type="button" class="w3-button w3-round-large w3-hover-red">Cancel</button></a>
                            </div>
                        </form>
                    </div>
                </div>
