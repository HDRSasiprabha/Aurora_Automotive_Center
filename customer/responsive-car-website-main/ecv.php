...
VALUES ('ecv',' $c_loc','$description',' $veh_id','$cid')";
            ...
            <div class="form-holder">
                <div class="form-content">
                    <div class="form-items">
                        <h3>Register Here for Requesting a Carieer Vehicle</h3>
                        ...
                        <form action="" method="POST" name="appointment" class="requires-validation" novalidate>
                           ...
                           <div class="col-md-12">
                           <input type="text" name="c_loc" id="c_loc" placeholder="Current Location" required/>
