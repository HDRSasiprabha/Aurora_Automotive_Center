        ...
        <div id="body" class="active">
            ...
            <div class="content">
                <div class="container">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <div class="icon-big text-center">
                                                <i class="ri-bill-fill" style="color:#c6356a"></i>
                                            </div>
                                        </div>
                                        <div class="col-sm-8">
                                            <div class="detail">
                                                <p class="detail-subtitle">Total Bills</p>
                            ...
                            <div class="card">
                                <div class="content">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <div class="icon-big text-center">
                                                <i class="ri-currency-line" style="color:#CCCCFF;"></i>
                                            </div>
                                        </div>
                                        <div class="col-sm-8">
                                            <div class="detail">
                                                <p class="detail-subtitle">Total Sales</p>
                                                <span class="number">Rs 180,900</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="footer">
                            ...
                            <div class="card">
                                <div class="content">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <div class="icon-big text-center">
                                                <i class="ri-money-cny-box-fill" style="color:#FFC300"></i>
                                            </div>
                                        </div>
                                        <div class="col-sm-8">
                                            <div class="detail">
                                                <p class="detail-subtitle">Awaiting Payments</p>
                            ...
                            <div class="card">
                                <div class="content">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <div class="icon-big text-center">
                                                <i class="fas fa-coins" style="color:#3B9C9C"></i>
                                            
                                            </div>
                                        </div>
                                        <div class="col-sm-8">
                                            <div class="detail">
                                                <p class="detail-subtitle">Finished Payments</p>
                   ...
                   <div >
                   <img style="margin:auto;display:block;" width=600px height=380px src="assets\img\cashier.svg" alt="draw" class="app-draw">
</div>
                    </div>
                </div>
            </div>
