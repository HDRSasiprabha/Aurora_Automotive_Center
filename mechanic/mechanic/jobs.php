            ...
            <div class="content">
                <div class="container">
                    ...
                    <div class="col-md-12 col-lg-12">
                            <div class="card">
                                <div class="card-header">Recent Job Details</div>
                                <div class="card-body">
                                                            ...
                                                            while($result=mysqli_fetch_assoc($query)){
                                                                echo "
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <a href='createQuo.php?job_id=".$result['job_id']."'
                                                                            class='btn btn-primary btn-sm'>Create Quotation</a>
                                                                            
                                                                            <a href='addTasks.php?job_id=".$result['job_id']."'
                                                                            class='btn btn-success btn-sm'>Add Tasks</a>

                                                                            <a href='viewTasks.php?job_id=".$result['job_id']."'
                                                                            class='btn btn-warning btn-sm'>View Tasks</a>
                                                                        </td>
                                                                    </tr>                     
